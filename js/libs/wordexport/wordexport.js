  ...
  (function ($) {
    $.fn.wordExport = function (fileName) {
      ...
      var styles = "@page WordSection1" +
        ...
        "div.WordSection1" +
        "{page:WordSection1;}";
      styles += "body{color:#000;font-size:18px;font-family:宋体, arial;}";
      styles += "table { table-layout: fixed; empty-cells: show; margin: auto auto; page-break-after: always; }"
      styles += "tbody{ vertical-align: top; }"

      if (CELLS_PER_PAGE === 25) {
        styles += "td { height: 122px; width: 150px; text-align:left; align:left;}"
      } else if (CELLS_PER_PAGE === 50) {
        styles += "td { height: 65px; width: 150px; text-align:left; align:left;}"
      } else {
        styles += "td { height: 32px; width: 150px; text-align:left; align:left;}"
      }
